<?php
  ...
  $training_data =  array_values(json_decode(file_get_contents("../data/apriori_datasets/retail_dataset.json"), true));

 //Initialize Main Apriori Algorithm Class With Required Required support and confidence percentage


  $apriori_associator =  new Apriori( $support =  0.17 , $confidence =  0.3);
  echo $apriori_associator->printHyperParameters();
  ...
  */
  $prediction = $apriori_associator->predict(["Watermelon"]); 
